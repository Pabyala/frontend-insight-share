            ...
            <div className="relative p-4 w-full max-w-sm max-h-full">
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700 p-3 space-y-3 lg:p-4">
                    ...
                    <div className="flex w-full space-x-3">
                        <button 
                            onClick={onCancel}
                            className="text-sm w-1/2 px-4 py-2 text-white bg-red-500 rounded-lg hover:bg-red-600"
                        >
                            Cancel
                        </button>
                        <button 
                            onClick={onConfirm}
                            className="text-sm w-1/2 px-4 py-2 text-white bg-blue-500 rounded-lg hover:bg-blue-600"
                        >
                            Confirm
                        </button>
                    </div>
